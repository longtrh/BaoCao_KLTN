			...
			if (invalid.equalsIgnoreCase("")) {
				try {
					DiaChi dc = new DiaChi(txtSoNha.getText(), txtTenDuong.getText(), txtPhuong.getText(),
							txtQuan.getText(), txtThanhPho.getText(), txtQuocGia.getText());
					if (khDao.addDiaChi(dc)) {
						FrmKhachHang.check = true;
						FrmKhachHang.txtMaDiaChi.setText(khDao.getMaDiaChiMax() + "");
						FrmKhachHang.txtDiaChi.setText(diaChi);
						JOptionPane.showMessageDialog(this, "Thêm địa chỉ thành công !", "Thông báo !",
								JOptionPane.CLOSED_OPTION);
						try {
							FrmKhachHang.themKhachHang();
							JOptionPane.showMessageDialog(this, "Đã thêm thông tin khách hàng !", "Thông báo !",
									JOptionPane.CLOSED_OPTION);
							FrmKhachHang.deleteAllDataTable();
							FrmKhachHang.docDuLieu();
						} catch (Exception e2) {
							JOptionPane.showMessageDialog(this, "Thêm thông tin khách hàng thất bại !", "Thông báo !",
									JOptionPane.ERROR_MESSAGE);
						}
						FrmKhachHang.btnThem.setEnabled(true);
