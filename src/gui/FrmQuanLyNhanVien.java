...
public class FrmQuanLyNhanVien extends JFrame implements ActionListener, MouseListener {
	...
	public FrmQuanLyNhanVien() {
		...
		pnlDanhSachNhanVien.setBounds(10, 237, 1297, 400);
		...
		scrollPane.setBounds(10, 20, 1277, 370);
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 */
		    ...
		    try {
		        // Kiểm tra trùng số điện thoại và CMND trong cơ sở dữ liệu trước
		        boolean daTonTai =nvDao.kiemTraNhanVienTonTai(sdt, cMND);
		        if (daTonTai) {
		    		...
		    		txtTenTK.setText("");
		    		txtCMND.setText("");
		            return; // Nếu trùng lặp, dừng thực hiện tiếp
		        }
		        ...
		        // Nếu không có lỗi, mở form tạo tài khoản
...
//		            // Kiểm tra trùng số điện thoại hoặc CMND

		            if (invalid.equalsIgnoreCase("")) {
		                // Thực hiện cập nhật nếu không có lỗi
		                if (nvDao.updateNhanVien(Integer.parseInt(txtMaNV.getText()), ho, ten,
		                        ngaySinhsql, cboGioiTinh.getSelectedItem().toString(), cmnd, sdt,
