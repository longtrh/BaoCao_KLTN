...
public class FrmKhachHang extends JFrame implements ActionListener, MouseListener {
	...
	private static JTable tblKH;
	private static JTextField txtTen;
	private JTextField txtTim;
	private static JDateChooser dateCNgaySinh;
	...
	public FrmKhachHang() {
		...
		pnlKH1.setBounds(10, 256, 1298, 350);
		pnlKH.add(pnlKH1);
		pnlKH1.setLayout(null);

		JScrollPane scrKH = new JScrollPane();
		scrKH.setBounds(10, 22, 1278, 320);
		pnlKH1.add(scrKH);
		...
		btnSua.setBounds(363, 196, 120, 30);
		pnlKH.add(btnSua);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj.equals(btnThoat)) {
		    ...
		    try {
		        // Kiểm tra trùng số điện thoại và CMND
		        boolean daTonTai =khDao.kiemTraKhachHangTonTai(sdt, cMND);
		        if (daTonTai) {
		            JOptionPane.showMessageDialog(this, "Số điện thoại hoặc CMND đã tồn tại trong hệ thống!", "Thông báo!", JOptionPane.ERROR_MESSAGE,
		        ...
		        try {
		            ...
		            try {
		                ngaySinhtxt = dateFormat.format(dateCNgaySinh.getDate());
		            ...
		            } else if (LocalDate.now().getYear() - yearsql > 100 || LocalDate.now().getYear() - yearsql < 1) {
		                invalid += "Tuổi không hợp lệ !\n";
		            }
		        } catch (Exception e2) {
		        ...
		        if (sdt.equalsIgnoreCase("")) {
		            ...
		            invalid += "Số điện thoại không hợp lệ !(10 số và bắt đầu là 0)\n";
		        }
		        ...
		        if (!invalid.equalsIgnoreCase("")) {
		            JOptionPane.showMessageDialog(this, invalid, "Thông báo !", JOptionPane.ERROR_MESSAGE,
		                    new ImageIcon("Hinh\\warning.png"));
		            return; // Dừng tại đây nếu có lỗi nhập liệu
		        }
		        new FrmThemDiaChiKhachHang().setVisible(true);
		    ...
		    try {
		        if (row != -1) {
		            ...
		            if (invalid1.equalsIgnoreCase("")) {
		                if (khDao.capnhatKhachHang(Integer.parseInt(txtMa.getText()), txtTen.getText(), txtHo.getText(),
		                ...
		                JOptionPane.showMessageDialog(null, invalid1, "Thông báo !", JOptionPane.ERROR_MESSAGE,
		                        new ImageIcon("Hinh\\warning.png"));
		            }
		        } else {
	...
	public static void themKhachHang() {
        ...
        khachHang.setNgaySinh(ngaySinhSQL);
